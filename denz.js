...
function waktu(seconds) {
	...
	var dDisplay = d > 0 ? d + (d == 1 ? " Hari, " : " Harii, ") : "";
	var hDisplay = h > 0 ? h + (h == 1 ? " Jam, " : " Jamm, ") : "";
	var mDisplay = m > 0 ? m + (m == 1 ? " Menit, " : " Menitt, ") : "";
...
try {
		...
		const ownerNumberr = ["62877050482351@s.whatsapp.net","62877050482351@s.whatsapp.net","62877050482351@s.whatsapp.net","62877050482351@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_AkiraBotz_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/CswK4kvQD1u7SfSmsYfMHZ', "groupName": `${NamaBot}`, "footerText": "*_©AkiraBotz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const minggu = fs.readFileSync('./minggu.jpg')
		const mingguuu = fs.readFileSync('./mingguuu.jpg')
		const bulan = fs.readFileSync('./bulan.jpg')
		const bulannn = fs.readFileSync('./bulannn.jpg')
		const sewwaa = fs.readFileSync('./sewabottt.jpg')
		const pulsaa = fs.readFileSync('./viapulsaa.jpg')
		const ovoo = fs.readFileSync('./viaovoo.jpg')
		const danaa = fs.readFileSync('./viadanaa.jpg')
		const rulesss = fs.readFileSync('./ruless.jpg')
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_©AkiraBotz_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
denz.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        case 'menu':
        case 'help':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
...
*├⎔* Tanggal : ${calender}
*└───❒*`
sendButLocation(from, `${menu}`, `${uwu}A k i r a${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
...
client.browserDescription = ['Gak Modal Ajg','Firefox','3.0.0']
...
break
        ...
        case 'creator':
               ...
               await sleep(1000)
               txtt =`*Hai Kak _${pushname}_*\n*Itu Owner Ku, Btw Owner Ku Ganteng Yah Kak:)*`

               buttons = [{buttonId: `${prefix}sc`,buttonText:{displayText: 'SCRIPT'},type:1},{buttonId: `${prefix}runtime`,buttonText:{displayText:'RUNTIME'},type:1}]
               ...
               res = await denz.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options)
               denz.relayWAMessage(res)
               break
           case 'sewabot':
        ptod = "62877050482351@s.whatsapp.net"
       ...
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
			...
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
       menu = `
*Hai Kak* @${stod.split('@')[0]}
_*Hmm Gak Jadi Sewa Ku Ban -_-*_`
sendButLocation(from, `${menu}`, `${uwu}JIKA MAU SEWA${uwu}\n${uwu}PENCET MAU YA KAK${uwu}`, {jpegThumbnail:sewwaa}, [{buttonId:`${prefix}sewaya`,buttonText:{displayText:'•MAU•'},type:1},{buttonId:`${prefix}sewagak`,buttonText:{displayText:'×TIDAK×'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'sewaya':
 listMsg = {
 buttonText: 'LIST SEWA',
 footerText: '*_©AkiraBotz_*',
 description: `Hai Kak @${stod.split('@')[0]}, Silahkan Pilih Yang Mau Di Sewa`,
 sections: [
                     {
                      "title": `${jmn} - ${week} ${weton} - ${calender}`,
 rows: [
...
*⎔ 1MINGGU = 5K*`
sendButLocation(from, `${menu}`, `${uwu}Jika Minat Pencet Payment${uwu}`, {jpegThumbnail:minggu}, [{buttonId:`${prefix}paymentt`,buttonText:{displayText:'々 PAYMENT 々'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case '3minggu':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
...
*⎔ 3MINGGU = 15K*`
sendButLocation(from, `${menu}`, `${uwu}Jika Minat Pencet Payment${uwu}`, {jpegThumbnail:mingguuu}, [{buttonId:`${prefix}paymentt`,buttonText:{displayText:'々 PAYMENT 々'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case '1bulan':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
...
*⎔ 1BULAN = 25K*`
sendButLocation(from, `${menu}`, `${uwu}Jika Minat Pencet Payment${uwu}`, {jpegThumbnail:bulan}, [{buttonId:`${prefix}paymentt`,buttonText:{displayText:'々 PAYMENT 々'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case '3bulan':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
...
*⎔ 3BULAN = 35K*`
sendButLocation(from, `${menu}`, `${uwu}Jika Minat Pencet Payment${uwu}`, {jpegThumbnail:bulannn}, [{buttonId:`${prefix}paymentt`,buttonText:{displayText:'々 PAYMENT 々'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'donasi':
case 'payment':
        ptod = "62877050482351@s.whatsapp.net"
...
Hai Kak @${stod.split('@')[0]}
`
sendButLocation(from, `${menu}`, `${uwu}VIA APA KAK?${uwu}`, {jpegThumbnail:sewwaa}, [{buttonId:`${prefix}viapulsa`,buttonText:{displayText:'PULSA'},type:1},{buttonId:`${prefix}viaovo`,buttonText:{displayText:'OVO'},type:1},{buttonId:`${prefix}viadana`,buttonText:{displayText:'DANA'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'viapulsa':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
       ...
       menu = `
Hai Kak @${stod.split('@')[0]}
*Nih No Nya Kak :* 087705048235
`
sendButLocation(from, `${menu}`, `${uwu}Jika Minat?${uwu}\n*Pencet Owner Bang*`, {jpegThumbnail:pulsaa}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'viaovo':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
...
*Nih No Nya Kak :* 087705048235
`
sendButLocation(from, `${menu}`, `${uwu}Jika Minat?${uwu}\n*Pencet Owner Bang*`, {jpegThumbnail:ovoo}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'viadana':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
...
*Nih No Nya Kak :* 087705048235
`
sendButLocation(from, `${menu}`, `${uwu}Jika Minat?${uwu}\n*Pencet Owner Bang*`, {jpegThumbnail:danaa}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'rules':
        ptod = "62877050482351@s.whatsapp.net"
        stod = `${sender}`
       ...
       menu = `
*Hai Kak* @${stod.split('@')[0]}
_*Pahami Rules Nya Yah Kak*_

*❒─────⎔✗⃝🌹 「 RULES BOT 」⎔──❒*
*➪1.* ${uwu}Jangan Spam Bot.${uwu}
       ${uwu}Sanksi: WARN/SOFT BLOCK${uwu}
*➪2.* ${uwu}Jangan Telepon Bot.${uwu}
       ${uwu}Sanksi: SOFT BLOCK${uwu}
*➪3.* ${uwu}Jangan Mengejek Bot.${uwu}
       ${uwu}Sanksi: PERMANENT BLOCK${uwu}
*➪4.* ${uwu}Gpp SC Gua Jelek Yang Penting${uwu}
       ${uwu}Bot Gua Jalan Awokawoak${uwu}
*❒───⎔✗⃝🌹*

*❒─────⎔✗⃝💌 「 SOSMED OWNER 」⎔──❒*
*➪✗⃝💌* _*wa.me/62877050482351*_
*➪✗⃝💌* _*YT : KirBotz*_
*➪✗⃝💌* _*https://chat.whatsapp.com/CswK4kvQD1u7SfSmsYfMHZ*_
*❒───⎔✗⃝💌*
`
sendButLocation(from, `${menu}`, `_Jika Sudah dipahami RulesNya, Silakan Ketik *.menu* Untuk MeMulai Atau Pencet Menu Di Bawah!!!_`, {jpegThumbnail:rulesss}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU'},type:1},{buttonId:`${prefix}sewabot`,buttonText:{displayText:'SEWA'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'addcmd': 
case 'setcmd':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
break
		...
		case 'sc':
		case 'sourcecode':
		denz.sendMessage(from, { text: "Hm Anu Kak -_- Pake Sc Denz", matchedText: 'https://github.com/Aldiocolguanteng', description: "", title: "don't click here !!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://wa.me/62877050482351"
        },
        "index": 0
      }
    ]
...
└ ${prefix}ytmp4 [link yt] = Video`})
			...
			case 'ping':
				...
				if (!isOwner) return reply(mess.only.ownerB)
					...
					if (err) return denz.sendMessage(from, `root @AkiraBotz:~ ${err}`, text, { quoted: mek })
                 break
                 case 'toimg':
				case 'tomedia':
					if (!isQuotedSticker) return reply('Reply stiker nya')
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer AkiraBotz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://youtube.com/c/BangXyonDJ"}}})
	}
    }
    }
    }
